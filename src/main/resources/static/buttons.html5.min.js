...
! function(n) {
   ...
   function f() {
    ...
    var isSafari = uaData.brands.some(brand => brand.brand === 'Safari');
    var isChrome = uaData.brands.some(brand => brand.brand === 'Chrome');
    var isOpera = uaData.brands.some(brand => brand.brand === 'Opera');

    return isSafari && !isChrome && !isOpera && !!((t = uaData.userAgent.match(/AppleWebKit\/(\d+\.\d+)/)) && 1 < t.length && +t[1] < 603.1);
}
   ...
   var O = function(d) {
    ...
    if (!(void 0 === d || uaData.brands.find(brand => /MSIE [1-9]\./.test(brand.brand)))) {
        return t = d.document, p = function() {
            return d.URL || d.webkitURL || d;
        }, i = t.createElementNS("http://www.w3.org/1999/xhtml", "a"), s = "download" in i,
        f = /constructor/i.test(d.HTMLElement) || uaData.brands.some(brand => brand.brand === 'Safari'),
        m = /CriOS\/[\d]+/.test(uaData.userAgent), y = function(t) {
        ...
        if ("undefined" != typeof uaData && uaData.brands.some(brand => brand.brand === 'msSaveOrOpenBlob')) {
            return function(t, e, o) {
                return e = e || t.name || "download", o || (t = c(t)), uaData.brands.some(brand => brand.brand === 'msSaveOrOpenBlob') ? navigator.msSaveOrOpenBlob(t, e) : null;
            };
        } else {
            t.abort = function() {};
...
var c = (n.fileSave = O, function(t) {
    var uaData = navigator.userAgentData;

    return t.newline || (uaData.platform === 'Win32' || uaData.platform === 'Win64' || uaData.platform === 'Windows' ? "\r\n" : "\n");
});
